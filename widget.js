(function () {
  ...
  var css = [
    ...
    'animation:fyf-breathe 2.4s ease-in-out infinite!important;transform-origin:right center!important;}',
    '@keyframes fyf-breathe{0%,100%{transform:scale(1);}50%{transform:scale(1.09);}}',
    ...
    '#fyf-btn.fyf-pulse{animation:fyf-bob 2.4s ease-in-out infinite;}',
    '@keyframes fyf-bob{0%,100%{transform:scale(1);}50%{transform:scale(1.06);}}',
    '#fyf-btn.fyf-pulse::after{animation:fyf-ring 1.8s ease-out infinite;}',
    '@keyframes fyf-ring{0%{box-shadow:0 0 0 0 rgba(138,111,87,.7);}',
    '70%{box-shadow:0 0 0 22px rgba(138,111,87,0);}',
    '100%{box-shadow:0 0 0 0 rgba(138,111,87,0);}}',
